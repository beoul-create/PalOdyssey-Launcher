    ...
    public class MainViewModel : INotifyPropertyChanged, IDisposable
    {
        ...
        public async Task OnPlayClickedAsync()
        {
            ...
            try
            {
                ...
                int deletedMusicFiles = _downloadManager.CleanupRetiredMusicFiles(GamePath);
                if (deletedMusicFiles > 0)
                {
                    SubStatusMessage = $"Removed {deletedMusicFiles} retired music-system file(s).";
                }
            ...
            catch (UnauthorizedAccessException uEx)
            {
                ...
                SubStatusMessage = uEx.Message;
                MessageBox.Show(
                    $"Access to a required file was denied:\n\n{uEx.Message}\n\nEnsure neither Windows nor an antivirus application is locking this path.",
                    "Permission Denied",
                    MessageBoxButton.OK,
