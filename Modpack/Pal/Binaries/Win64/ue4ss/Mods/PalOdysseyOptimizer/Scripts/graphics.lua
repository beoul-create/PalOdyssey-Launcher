...
function GraphicsModule.apply(cfg, cpuCfg)
    ...
    local function optimizeRenderSettings()
        ...
        -- 4. Smart On-Demand Viewport Texture Streaming (Smooth Mount/Dismount Transitions)
        if not (_G.FastConnect and _G.FastConnect.Config and _G.FastConnect.Config.accelerateLoadingScreens) then
            ...
            ExecuteConsole("r.Streaming.FramesForFullUpdate 5")
            ExecuteConsole("r.Streaming.MaxNumTexturesToStreamPerFrame 24")
