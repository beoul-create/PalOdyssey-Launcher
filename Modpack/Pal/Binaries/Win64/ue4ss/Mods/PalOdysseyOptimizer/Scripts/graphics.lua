...
function GraphicsModule.apply(cfg, cpuCfg)
    ...
    local function optimizeRenderSettings()
        ...
        -- 4. Asynchronous Texture Streaming & CPU Amortization (Memory Optimized)
        ...
        ExecuteConsole("r.Streaming.PoolSize 1280")
        ExecuteConsole("r.Streaming.Boost 1")
        ExecuteConsole("r.Streaming.FullyLoadUsedTextures 0")
        ExecuteConsole("gc.TimeBetweenPurgingPendingKillObjects 30")
