...
function GraphicsModule.apply(cfg, cpuCfg)
    ...
    local function optimizeRenderSettings()
        ...
        -- 6. High-Performance Crisp Shadows (Optimized 1024p CSM, 2 Cascades, Contact Shadows)
        ...
        ExecuteConsole("r.ShadowQuality 2")
        ExecuteConsole("r.Shadow.Virtual.Enable 0")
        ExecuteConsole("r.Shadow.MaxCSMResolution 1024")
        ExecuteConsole("r.Shadow.MaxResolution 1024")
        ExecuteConsole("r.Shadow.CSM.MaxCascades 2")
        ExecuteConsole("r.Shadow.DistanceScale 0.90")
        ExecuteConsole("r.Shadow.CSM.TransitionScale 1.0")
        ExecuteConsole("r.Shadow.FilterMethod 1")
        ExecuteConsole("r.Shadow.RadiusThreshold 0.03")
        ExecuteConsole("r.Shadow.FadeResolution 64")
        ExecuteConsole("r.ContactShadows 1")
        ExecuteConsole("r.ContactShadows.NonShadowCastingIntensity 0.3")
        ExecuteConsole("r.DistanceFieldShadowing 0")
        ExecuteConsole("r.DFShadowQuality 0")
        ExecuteConsole("r.AmbientOcclusionLevels 1")
        ExecuteConsole("r.AmbientOcclusionMaxQuality 0")
        ExecuteConsole("r.AmbientOcclusionRadiusScale 1.0")
        ...
        -- Hardware NVIDIA DLSS 3 & Frame Generation on RTX 40-Series
